...
class GRAN(nn.Module):
    ...
    def __init__(self, nb_layer, in_dim_node, out_dim_node, hidden_dim, nb_max_node, dim_order_embedding):
        super().__init__()
        ...
        self.node_embedding = nn.Parameter(torch.randn(nb_max_node, dim_order_embedding))
