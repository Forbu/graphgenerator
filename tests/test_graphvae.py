...
def test_decoder():
    ...
    graph_decoder = GraphDecoder(nb_layers=2, in_dim=3, hidden_dim=4, out_dim=10*10, nb_nodes=10)
...
def test_graphvae():
    ...
    # init graph decoder
    graph_decoder = GraphDecoder(nb_layers=2, in_dim=5, hidden_dim=4, out_dim=10*10, nb_nodes=10)
